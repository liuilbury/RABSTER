...
/* the parser we are creating output for *//*

	FILE *outputf;
	struct keyval *rkv; */
/* current read key:val *//*

	struct keyval_list *curlist;
	bool do_token_check = true; */
/* if the check for valid tokens is done *//*

	bool only_ident = true; */
/* if the only token type is ident *//*
	...
	if ((argv[1][0] == '-') && (argv[1][1] == 'o')) {
		...
		if (outputf == NULL) {
			...
			return 2; */
/* exit on output file output error *//*
