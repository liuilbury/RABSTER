...
enum css_properties_e {
	...
	///transition
	CSS_PROP_TRANSITION_DELAY				= 0x07c,
	CSS_PROP_TRANSITION_DURATION			= 0x07d,
	CSS_PROP_TRANSITION_PROPERTY			= 0x07e,
	CSS_PROP_TRANSITION_TIMING_FUNCTION		= 0x07f,
	///
	CSS_N_PROPERTIES
};
...
enum css_transition_delay_e{
	...
	CSS_TRANSITION_DELAY_AUTO			=0x2
};
enum css_transition_duration_e{
	CSS_TRANSITION_DURATION_INHERIT 		=0x0,
	CSS_TRANSITION_DURATION_SET				=0x1,
	CSS_TRANSITION_DURATION_AUTO			=0x2
};
enum css_transition_property_e{
	CSS_TRANSITION_PROPERTY_INHERIT 		=0x0,
	CSS_TRANSITION_PROPERTY_SET				=0x1,
	CSS_TRANSITION_PROPERTY_ALL				=0x2,
	CSS_TRANSITION_PROPERTY_NONE			=0x3,
};
enum css_transition_timing_function_e{
	CSS_TRANSITION_TIMING_FUNCTION_INHERIT 		=0x0,
	CSS_TRANSITION_TIMING_FUNCTION_LINEAR		=0x1,
	CSS_TRANSITION_TIMING_FUNCTION_EASE			=0x2,
	CSS_TRANSITION_TIMING_FUNCTION_EASE_IN		=0x3,
	CSS_TRANSITION_TIMING_FUNCTION_EASE_OUT		=0x4,
	CSS_TRANSITION_TIMING_FUNCTION_EASE_IN_OUT	=0x5,
};
///
