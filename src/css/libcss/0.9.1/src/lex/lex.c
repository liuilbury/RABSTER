...
css_error AtKeyword(css_lexer* lexer, css_token** token)
{
	...
	enum
	{
		Initial = 0, Escape = 1, NMChar = 2
	};

	/* ATKEYWORD = '@' ident  = '@' '-'? nmstart nmchar*
	 *
...
css_error URI(css_lexer* lexer, css_token** token)
{
	...
	enum
	{
		Initial = 0, LParen = 1, W1 = 2, Quote = 3,
