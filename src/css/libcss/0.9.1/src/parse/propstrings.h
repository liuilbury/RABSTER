...
enum {
	...
	TABLE_LAYOUT, TEXT_ALIGN, TEXT_DECORATION, TEXT_INDENT, TEXT_TRANSFORM, TOP,
	///新增transition
	TRANSITION, TRANSITION_DELAY, TRANSITION_DURATION, TRANSITION_PROPERTY,TRANSITION_TIMING_FUNCTION,
	///
	UNICODE_BIDI, VERTICAL_ALIGN, VISIBILITY, VOICE_FAMILY,
