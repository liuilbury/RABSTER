...
///transition
enum op_transition_delay{
	TRANSITION_DELAY_SET			=0x0080,

	TRANSITION_DELAY_AUTO			=0x0000
};
enum op_transition_duration{
	TRANSITION_DURATION_SET			=0x0080,

	TRANSITION_DURATION_AUTO			=0x0000
};
enum op_transition_property{
	TRANSITION_PROPERTY_SET			=0x0080,

	TRANSITION_PROPERTY_NONE		=0x0000,
	TRANSITION_PROPERTY_ALL			=0x0001
};
enum op_transition_timing_function{
	TRANSITION_TIMING_FUNCTION_SET			=0x0080,

	TRANSITION_TIMING_FUNCTION_LINEAR		=0x0000,
	TRANSITION_TIMING_FUNCTION_EASE			=0x0001,
	TRANSITION_TIMING_FUNCTION_EASE_IN		=0x0002,
	TRANSITION_TIMING_FUNCTION_EASE_OUT		=0x0003,
	TRANSITION_TIMING_FUNCTION_EASE_IN_OUT		=0x0004,
};
///
#endif
